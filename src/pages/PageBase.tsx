...
import StepConfigPage from './function/StepConfigPage';
import FlowBuilderPage from './function/FlowBuilderPage';
...
export default function PageBase() {
	...
	const [rightPanelWidth, setRightPanelWidth] = useState(300); // 初期幅
	...
	const renderContent = () => {
		switch (selectedPage) {
			case 'home':
				return <HomePage setRightPanel={setRightPanelContent} />;
			case 'step':
